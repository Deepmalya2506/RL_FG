...
if __name__ == '__main__':  # NOTE: This is REQUIRED on Windows!
    ...
    # Now setup the reciever : It is the python sending commands to the FG. Commands: As designed in the fdm_callback funtion
    fdm_event_pipe = fdm_conn.connect_rx('localhost', 5501, fdm_callback)

    # Now the transmitter setup: It is the FG sending commands to the Python
    fdm_conn.connect_tx('localhost', 5502) #Here we don't have any function from FG, i.e the flightgear is not sending any commands here
